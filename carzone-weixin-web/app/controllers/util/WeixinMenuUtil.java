...
import controllers.pojo.UserList;
import controllers.pojo.WeixinUserInfo;
...
public class WeixinMenuUtil {
	...
	public static AccessToken getAccessToken(String appid, String appsecret) {
		...
		if (jsonObject != null){
			try {
				...
				accessToken = null;
				log.error("��ȡtokenʧ�� errcode:{} errmsg:{}", Integer.valueOf(jsonObject.getInt("errcode")), jsonObject.getString("errmsg"));
			}
		}
		return accessToken;
	}
	...
	public static int createMenu(Menu menu, String accessToken) {
		...
		if (jsonObject != null && jsonObject.getInt("errcode") != 0) {
			...
			log.error("错误码 errcode:{} errmsg:{}", Integer.valueOf(jsonObject.getInt("errcode")), jsonObject.getString("errmsg"));
		}
		return result;
	}
	...
	public static WeixinUserInfo getUserInfo(String openId, String accessToken) {
		...
		if (jsonObject != null){
			try {
				...
				user.setSex(1 != jsonObject.getInt("sex") ? "Ů" : "��");
				...
				if (user.getOpenId() == null) {
					user = null;
					log.error("��ȡ�û���Ϣʧ�� errcode:{} errmsg:{}", Integer.valueOf(jsonObject.getInt("errcode")), jsonObject.getString("errmsg"));
				} else if (user.getSubscribe() == 0)
					log.error("�û�{}��ȡ���ע", user.getOpenId());
			}
		}
		return user;
	}
	...
	public static UserList getUserList(String accessToken, String nextOpenId) {
		...
		if (jsonObject != null){
			try {
				...
				e.printStackTrace();
				log.error("��ȡ�����˻���ע�û��б� errcode:{} errmsg:{}", Integer.valueOf(jsonObject.getInt("errcode")), jsonObject.getString("errmsg"));
			}
		}
		return userList;
	}
		...
		if (jsonMsg != null) {
			...
			if (jsonObject != null)
				if (jsonObject.getInt("errcode") == 0) {
					...
					result = 0;
					log.error("������Ϣʧ�� errcode:{} errmsg:{}", Integer.valueOf(jsonObject.getInt("errcode")), jsonObject.getString("errmsg"));
				}
		}
		return result;
	}
	...
	public static int pushImageFile(String openId, String imageUrl, String accessToken) {
		...
		try {
			...
			result = jsonObject.getInt("errcode");
			log.info("����ͼƬ�ļ� errcode:{} errmsg:{}", Integer.valueOf(jsonObject.getInt("errcode")), jsonObject.getString("errmsg"));
		} catch (Exception e) {
			log.error("����ý���ļ��쳣��{}",e);
		}
		return result;
	...
	public static int pushVoiceFile(String openId, String voiceUrl, String accessToken) {
		...
		try {
			...
			JSONObject jsonObject = JSONObject.fromObject(buffer.toString());
			result = jsonObject.getInt("errcode");
			log.info("������Ƶ�ļ� errcode:{} errmsg:{}", Integer.valueOf(jsonObject.getInt("errcode")), jsonObject.getString("errmsg"));
		} catch (Exception e) {
			log.error("����ý���ļ��쳣��{}", e);
		}
		return result;
